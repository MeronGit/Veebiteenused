 ...
 * 
 */
@WebServiceClient(name = "LibraryService", targetNamespace = "http://www.ttu.ee/idu0075/2015/ws/library", wsdlLocation = "file:/D:/Merli%20Backup/Merli_backup/Eclipse/LibraryBooksWebApplication/src/conf/xml-resources/web-services/LibraryWebService/wsdl/LibraryService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName LIBRARYSERVICE_QNAME = new QName("http://www.ttu.ee/idu0075/2015/ws/library", "LibraryService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Merli%20Backup/Merli_backup/Eclipse/LibraryBooksWebApplication/src/conf/xml-resources/web-services/LibraryWebService/wsdl/LibraryService.wsdl");
    ...
    public LibraryPortType getLibraryPort() {
        return super.getPort(new QName("http://www.ttu.ee/idu0075/2015/ws/library", "LibraryPort"), LibraryPortType.class);
    }
    ...
    public LibraryPortType getLibraryPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.ttu.ee/idu0075/2015/ws/library", "LibraryPort"), LibraryPortType.class, features);
    }
